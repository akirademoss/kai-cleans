      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-xl text-gray-400">Our standard deep clean service is priced hourly and includes the same tasks as our First-Time Clean. We will hand-wipe what we can safely reach with a 2-step step stool. To learn more about what we can do for you, speak with your phClean consultant today.</p>
          </div>          
