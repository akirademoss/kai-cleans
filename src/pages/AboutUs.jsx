                                        ...
                                        <div class="w-full flex-col justify-center lg:items-start items-center gap-10 inline-flex">
                                            <div class="w-full flex-col justify-center items-start gap-8 flex">
                                                ...
                                                <div class="w-full lg:justify-start justify-center items-center sm:gap-10 gap-2 inline-flex" >
                                                    <div class="flex-col justify-start items-start inline-flex"  data-aos="fade-down" data-aos-delay="100" >
                                                    ...
                                                    <div class="flex-col justify-start items-start inline-flex"  data-aos="fade-down" data-aos-delay="200" >
                                            ...
                                            <button
                                                class="sm:w-fit w-full px-3.5 py-2 bg-blue-600 hover:bg-gray-500 transition-all duration-700 ease-in-out rounded-lg shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] justify-center items-center flex">
                                                <span class="px-1.5 text-white text-sm font-medium leading-6">Read Reviews</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
