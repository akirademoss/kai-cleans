                                            ...
                                            <div class="w-full flex-col justify-center items-start gap-8 flex">
                                                <div class="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                                                    ...
                                                    <p class="text-gray-400 text-xl font-normal leading-relaxed lg:text-start text-center"
                                                        ...
                                                        Our early adopters have the opportunity to shape the direction of our company while also earning discounts for their valuable feedback.  We are proudly Black and LGBTQ+ owned and operated.  
                                                        </p>
                                                </div>
